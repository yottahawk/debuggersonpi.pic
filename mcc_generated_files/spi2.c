...
{
    // MSTEN Slave; DISSDO disabled; PPRE 64:1; SPRE 8:1; MODE16 disabled; SMP Middle; DISSCK disabled; CKP Idle:Low, Active:High; CKE Idle to Active; 
    SPI2CON1 = 0x0000;
    // SPIBEN enabled; SPIFPOL disabled; SPIFE disabled; 
    SPI2CON2 = 0x0001;
    // SPITBF disabled; SISEL SPI_INT_SPIRBF; SPIRBF disabled; SPIROV disabled; SPIEN enabled; SPISIDL disabled; SPIBEC disabled; 
    SPI2STAT = 0x800C;
}
